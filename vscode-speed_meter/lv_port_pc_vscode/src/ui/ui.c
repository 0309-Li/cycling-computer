...
//! 运动状态
static char *sport_status[] = {"running", "stop", "pause"};
...
void __ui_speed_meter_all_sub_init(void)
{
    ...
    /* 运动状态主题 */
    lv_subject_init_pointer(&speed_meter_sub->sport_status, sport_status[1]);
    /* 电池电量主题 */
...
static void sport_status_observer_cb(lv_observer_t *observer, lv_subject_t *subject)
{
    ...
    const char *status_key = (const char *)lv_subject_get_pointer(subject);
