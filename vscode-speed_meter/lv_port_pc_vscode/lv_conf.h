...
#define LV_USE_FS_WIN32 1
    ...
    #define LV_FS_WIN32_PATH "E:/ShangGuiGu/learn_code/keil_32_code/vscode_cycling computer/bj_map"         /**< Set the working directory. File/directory paths will be appended to it. */
